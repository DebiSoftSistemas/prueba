...
<head>
    ...
    <title>ROTHMAN | Presentación</title>
    <style>
        ...
        @keyframes neonGlow {
            from { text-shadow: 0 0 10px rgba(255,0,204,0.7), 0 0 20px rgba(255,0,204,0.5); }
            to { text-shadow: 0 0 15px rgba(51,51,255,0.7), 0 0 30px rgba(51,51,255,0.5); }
        }
